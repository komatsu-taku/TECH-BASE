<?php
    ...
    function get_next_index($filename, $sep){
        /*
        ...
        */
        ...
        $final_index = explode($sep, $last_data)[1];
        return (int)$final_index + 1;
    }
    ...
    function add_data_to_file($filename, $contents, $sep){
        ...
        */
        ...
        $index = get_next_index($filename, $sep);
...
<html>
    ...
    <body>
        ...
        <form action="" method="post">
            <input type="text" name="password" placeholder="パスワードを入力">
            <input type="number" name="index" placeholder="削除するインデックスを入力">
